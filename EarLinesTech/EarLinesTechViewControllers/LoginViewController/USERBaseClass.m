...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.jobRights = [[self objectOrNilForKey:kUSERBaseClassJobRights fromDictionary:dict]intValue];
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:[NSNumber numberWithInt:self.jobRights] forKey:kUSERBaseClassJobRights];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    self.jobRights = [aDecoder decodeDoubleForKey:kUSERBaseClassJobRights];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_jobRights forKey:kUSERBaseClassJobRights];
